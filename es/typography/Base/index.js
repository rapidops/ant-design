...
var Base = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _React$useState9 = React.useState(false),
    ...
    isJsEllipsis = _React$useState0[0],
    setIsJsEllipsis = _React$useState0[1];
  var _React$useState1 = React.useState(false),
    _React$useState10 = _slicedToArray(_React$useState1, 2),
    isNativeEllipsis = _React$useState10[0],
    setIsNativeEllipsis = _React$useState10[1];
  var _React$useState11 = React.useState(true),
    _React$useState12 = _slicedToArray(_React$useState11, 2),
    isNativeVisible = _React$useState12[0],
    setIsNativeVisible = _React$useState12[1];
  ...
  var _React$useState15 = React.useState(0),
    ...
    ellipsisFontSize = _React$useState16[0],
    setEllipsisFontSize = _React$useState16[1];
